                ...
                <div className="max-w-4xl mx-auto px-8 py-16">
                    ...
                    <div className="mb-20 space-y-6">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                            Driven and detail-oriented Fresher ready to build scalable, high-performance web applications. Equipped with a strong foundation in MERN stack, Next.js, and modern development practices, I am eager to contribute to innovative projects and deliver exceptional results.
                        </p>

                        {/* Social Links */}
                        <div className="flex flex-wrap gap-3 pt-3">
                            <a href="mailto:aditya.raj2024@nst.rishihood.edu.in" className="px-4 py-2 bg-gray-900 text-white rounded-full text-sm font-medium hover:bg-gray-800 transition-colors">
                                Email Me
                            </a>
                        </div>
                        ...
                        <div className="pt-4 space-y-3">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <div className="flex items-center gap-2 px-3 py-1 bg-blue-50 text-blue-700 rounded-lg text-xs font-semibold border border-blue-200">
                                    ...
                                    <span className="text-blue-800">650+</span>
                                </div>
                            </div>

                            {/* Social Text Links */}
                            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm">
                                <a href="https://www.linkedin.com/in/aditya-raj-2630b6323/" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-colors font-medium">LinkedIn</a>
                                <a href="https://github.com/RajAditya7777" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-colors font-medium">GitHub</a>
                                <a href="https://leetcode.com/u/adyraj7777/" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-colors font-medium">LeetCode</a>
                                <a href="https://codeforces.com/profile/aditya.raj7777" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-black transition-colors font-medium">Codeforces</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid gap-8">
                            ...
                            <div className="group relative border-l-2 border-gray-100 pl-8 hover:border-blue-600 transition-colors duration-300">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between mb-2">
                                    <h4 className="text-xl font-bold text-gray-900">Fresher / Aspiring Full Stack Developer</h4>
                                ...
                                <div className="mb-4">
                                    <span className="text-blue-600 font-medium">Open to Work</span>
                                    <span className="text-gray-400 mx-2">•</span>
                                    <span className="text-gray-500 text-sm">Remote / On-site</span>
                                </div>

                                <ul className="space-y-3 text-gray-600 leading-relaxed">
                                    <li className="flex gap-2 items-start">
                                        <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
                                        <span>Kickstarting my journey with a deep passion for problem-solving and clean code architecture.</span>
                                    </li>
                                    <li className="flex gap-2 items-start">
                                        <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
                                        <span>Proficient in building full-stack applications using React, Node.js, and TypeScript.</span>
                                    </li>
                                    <li className="flex gap-2 items-start">
                                        <span className="mt-2 w-1.5 h-1.5 bg-blue-400 rounded-full flex-shrink-0"></span>
                                        <span>Ready to collaborate, learn, and drive impact in a dynamic development environment.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <footer className="mt-20 pt-8 border-t border-gray-100 text-center text-gray-400 text-sm">
                        <p>© 2026 Aditya Raj. Built with React & Tailwind.</p>
                    </footer>
