      ...
      children: [
        {
          ...
          description: [
            ...
            "",
            "DESCRIPTION:",
            "Built with React.js and Tailwind CSS, featuring seamless navigation using React Router and a clean, modern UI for an intuitive user experience. Integrated the AviationStack API to provide real-time flight tracking, including live status updates, departure and arrival details, and route information.",
            "",
            "KEY FEATURES:",
            "• Real-time flight tracking with AviationStack API.",
            "• Live status updates, departure/arrival details, and route info.",
            "• Responsive, interactive flight search dashboard with dynamic filters and status badges.",
            "• Smart search and filtering for efficient journey planning.",
            "",
            "TECH STACK:",
