      ...
      children: [
        {
          ...
          description: [
            ...
            "",
            "PROBLEM:",
            "Students struggle to organize and extract insights from fragmented study materials like PDFs and loose notes.",
            "",
            "SOLUTION:",
            "An AI-powered workspace enabling users to upload documents and interact with them intelligently via chat, summaries, and quizzes.",
            "",
            "TECH STACK:",
            ...
            "",
            "OPTIMIZATIONS:",
            "• Implemented optimistic UI updates for smoother workspace navigation.",
            "• Cached AI responses to reduce API costs and latency.",
            "",
            "TRADE-OFFS:",
            "• Chose specific AI models balancing cost vs. response quality.",
            "",
            "LEARNINGS:",
      ...
      children: [
        {
          ...
          description: [
            ...
            "",
            "PROBLEM:",
            "Existing dating apps often lack verification, leading to safety concerns among students.",
            "",
            "SOLUTION:",
            ...
            "• Auth: Clerk (Student Verification)",
            "",
            "OPTIMIZATIONS:",
            "• Optimized image loading with lazy loading for profile cards.",
            "• Used Clerk for secure, rapid authentication implementation.",
            "",
            "TRADE-OFFS:",
            "• Restricted user base to students only to ensure safety over rapid scale.",
            "",
            "LEARNINGS:",
            "• Built and deployed a production-ready app in 6 weeks with a 3-member team.",
            "• Achieved 17,000+ views through targeted Instagram marketing.",
          ],
        },
        {
          id: 2,
      ...
      children: [
        {
          ...
          description: [
            ...
            "",
            "PROBLEM:",
            "Flight tracking information is often scattered across clunky, outdated interfaces.",
            "",
            "SOLUTION:",
            "A clean, modern dashboard providing real-time flight status, departure/arrival details, and route info in one place.",
            "",
            "TECH STACK:",
            ...
            "",
            "OPTIMIZATIONS:",
            "• Implemented debounced search to reduce excessive API calls.",
            "• Used React Router for seamless client-side navigation.",
            "",
            "TRADE-OFFS:",
            "• Relies on external AviationStack API availability.",
            "",
            "LEARNINGS:",
            "• Managing real-time data integration and complex API responses.",
          ],
        },
        {
          id: 2,
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/RajAditya7777/Jet_Journey_",
          position: "top-10 right-20",
        },
        {
          id: 3,
          ...
          kind: "file",
          fileType: "url",
          href: "https://jet-journey.vercel.app/",
          position: "top-20 right-40",
        },
      ],
    },
